...
function S_Main({ startDate, endDate, onReservation }) {
    ...
    const handleReservation = () => {
        if (selectedDate) {
            ...
            navigate('/S_Other', { state: { selectedDate: selectedDate } });
    ...
    const events = [ //여기에다가 백에서 정보를 가져다 배열을 작성하는 코드 작성, 지금 작성한 코드는 테스트용임
        {
            title: '전혈',
